...
using Task_Identity_Role_Claim_User.Models;

namespace Task_Identity_Role_Claim_User
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("Identity_Db_1")));
            //services
