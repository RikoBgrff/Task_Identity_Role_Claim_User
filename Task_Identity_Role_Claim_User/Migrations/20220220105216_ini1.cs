        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomClaim_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleClaims_CustomClaim_ClaimId",
                        column: x => x.ClaimId,
                        principalTable: "CustomClaim",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserClaims_CustomClaim_ClaimId",
                        column: x => x.ClaimId,
                        principalTable: "CustomClaim",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
